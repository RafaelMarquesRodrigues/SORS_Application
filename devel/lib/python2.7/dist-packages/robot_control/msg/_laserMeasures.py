...
"""autogenerated by genpy from robot_control/laserMeasures.msg. Do not edit."""
import sys
...
class laserMeasures(genpy.Message):
  _md5sum = "7b95a89dd4dc981e642360131c830c02"
  _type = "robot_control/laserMeasures"
...
"""
  __slots__ = ['header','range','angle','front']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(laserMeasures, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_d.pack(self.front))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.front,) = _struct_d.unpack(str[start:end])
      return self
