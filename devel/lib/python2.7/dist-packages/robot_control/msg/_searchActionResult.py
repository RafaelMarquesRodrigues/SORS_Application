...
"""autogenerated by genpy from robot_control/searchActionResult.msg. Do not edit."""
import sys
...
class searchActionResult(genpy.Message):
  ...
  _type = "robot_control/searchActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_control/searchResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = robot_control.msg.searchResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_control.msg.searchResult()
