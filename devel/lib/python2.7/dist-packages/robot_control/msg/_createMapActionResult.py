...
"""autogenerated by genpy from robot_control/createMapActionResult.msg. Do not edit."""
import sys
...
class createMapActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "robot_control/createMapActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_control/createMapResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(createMapActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_control.msg.createMapResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_control.msg.createMapResult()
