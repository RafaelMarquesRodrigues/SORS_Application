...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/rafael/SORS_Application/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/rafael/SORS_Application/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/rafael/SORS_Application/install)
...
if(NOT "/home/rafael/SORS_Application/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/indigo/include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/rafael/SORS_Application/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/indigo/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rafael/SORS_Application/src/geometry/eigen_conversions/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rafael/SORS_Application/devel/lib;/opt/ros/indigo/lib)
