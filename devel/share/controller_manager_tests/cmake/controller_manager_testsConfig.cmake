...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_tests_SOURCE_PREFIX /home/rafael/SORS_Application/src/ros_control/controller_manager_tests)
  set(controller_manager_tests_DEVEL_PREFIX /home/rafael/SORS_Application/devel)
  ...
  set(controller_manager_tests_INSTALL_PREFIX /home/rafael/SORS_Application/install)
...
if(NOT "/home/rafael/SORS_Application/src/ros_control/controller_manager_tests/include " STREQUAL " ")
  set(controller_manager_tests_INCLUDE_DIRS "")
  set(_include_dirs "/home/rafael/SORS_Application/src/ros_control/controller_manager_tests/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rafael/SORS_Application/src/ros_control/controller_manager_tests/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
