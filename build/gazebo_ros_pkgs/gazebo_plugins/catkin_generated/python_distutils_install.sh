...
echo_and_run cd "/home/rafael/SORS_Application/src/gazebo_ros_pkgs/gazebo_plugins"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/rafael/SORS_Application/build/gazebo_ros_pkgs/gazebo_plugins" \
    install \
    $DESTDIR_ARG \
