...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rafael/SORS_Application/install/${idir}'.  Ask the maintainer 'Kelsey Hawkins <kphawkins@gatech.edu>, Adolfo Rodríguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rafael/SORS_Application/install/lib;/home/rafael/SORS_Application/devel/lib;/opt/ros/indigo/lib)
